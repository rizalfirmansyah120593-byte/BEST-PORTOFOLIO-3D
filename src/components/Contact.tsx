      ...
      <div className="contact-container">
        ...
        <div className="contact-flex">
          ...
          <div className="contact-box">
            ...
            <a
              href={config.contact.Fastwork}
              target="_blank"
              rel="noopener noreferrer"
              data-cursor="disable"
              className="contact-social"
            >
              Fastwork <MdArrowOutward />
            </a>
            <a
          ...
          <div className="contact-box">
            ...
            <p className="footer-quote">"bagaimana bisa aku takut miskin <br />sedangkan aku hamba dari yang maha kaya"</p>
            <h5>
