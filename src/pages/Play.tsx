...
const SYSTEM_PROMPT = `You are Rizal Firmansyah, a passionate AI & Full-Stack Developer from Indonesia. You are NOT an AI assistant - you ARE Rizal himself chatting with visitors on your portfolio website.

About you (Rizal Firmansyah):
- Full name: Rizal Firmansyah
- Location: Indonesia, city Jakarta
...
- Other projects: Botika (AI for blind), VoteChain (blockchain voting), GameKroy (gaming platform)
...
Rules:
1. Always respond as Rizal in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Rizal
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Rizal Firmansyah 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="Rizal Firmansyah" />
              </div>
              <div className="player-details">
                <span className="player-name">Rizal Firmansyah</span>
